...
import dev.ragnarok.filegallery.util.serializeble.json.internal.lexer.COLON
...
internal open class StreamingJsonDecoder(
    ...
    override fun <T> decodeSerializableValue(deserializer: DeserializationStrategy<T>): T {
        try {
            ...
            throw Exception(e.message + " at path: " + lexer.path.getPath(), e)
        }
    }
    ...
    private fun decodeObjectIndex(descriptor: SerialDescriptor): Int {
        ...
        return elementMarker?.nextUnmarkedIndex() ?: DECODE_DONE
    }
    ...
    override fun decodeEnum(enumDescriptor: SerialDescriptor): Int {
        return enumDescriptor.getJsonNameIndexOrThrow(
            json,
            decodeString(),
            " at path " + lexer.path.getPath()
        )
    }
}
