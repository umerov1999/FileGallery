...
internal class MainSettings(context: Context) : IMainSettings {
    ...
    override fun getFontSize(): Int {
        return try {
            PreferenceScreen.getPreferences(app).getString("font_size", "0")!!.trim().toInt()
        } catch (e: Exception) {
            0
        }
    }
    ...
    override fun getThemeOverlay(): Int {
        return try {
            PreferenceScreen.getPreferences(app).getString("theme_overlay", "0")!!.trim().toInt()
        } catch (e: Exception) {
            ThemeOverlay.OFF
        }
    }
    ...
    override fun getMainThemeKey(): String {
        val preferences = PreferenceScreen.getPreferences(app)
    ...
    override fun getLocalServer(): LocalServerSettings {
        val ret = PreferenceScreen.getPreferences(app).getString("local_media_server", null)
        return if (ret == null) {
            LocalServerSettings()
        } else {
    ...
    override fun getPlayerCoverBackgroundSettings(): PlayerCoverBackgroundSettings {
        val ret =
            PreferenceScreen.getPreferences(app).getString("player_background_settings_json", null)
        return if (ret == null) {
    ...
    override fun getSlidrSettings(): SlidrSettings {
        val ret = PreferenceScreen.getPreferences(app).getString("slidr_settings_json", null)
        return if (ret == null) {
    ...
    override fun getMusicLifecycle(): Int {
        return try {
            var v = PreferenceScreen.getPreferences(app).getString(
    ...
    override fun getMaxBitmapResolution(): Int {
        return try {
            PreferenceScreen.getPreferences(app).getString("max_bitmap_resolution", "4000")!!.trim()
                .toInt()
        } catch (e: Exception) {
            4000
        }
    ...
    override fun getMaxThumbResolution(): Int {
        return try {
            PreferenceScreen.getPreferences(app).getString("max_thumb_resolution", "384")!!.trim()
                .toInt()
        } catch (e: Exception) {
            384
        }
    ...
    override fun getRendering_mode(): Int {
        return try {
            PreferenceScreen.getPreferences(app).getString("rendering_mode", "0")!!.trim().toInt()
        } catch (e: Exception) {
            0
        }
    }
    ...
    override fun getFFmpegPlugin(): Int {
        return try {
            PreferenceScreen.getPreferences(app).getString("ffmpeg_audio_codecs", "1")!!.trim()
                .toInt()
        } catch (e: Exception) {
            1
        }
    ...
    override fun isAudio_round_icon(): Boolean {
        return PreferenceScreen.getPreferences(app).getBoolean("audio_round_icon", true)
    }
    ...
    override fun isRevert_play_audio(): Boolean {
        return PreferenceScreen.getPreferences(app).getBoolean("revert_play_audio", false)
    }
    ...
    override fun getViewpager_page_transform(): Int {
        return try {
            PreferenceScreen.getPreferences(app).getString(
