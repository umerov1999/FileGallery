package dev.ragnarok.filegallery.filepicker.view;
...
import dev.ragnarok.filegallery.filepicker.controller.adapters.FileListAdapter;
...
import dev.ragnarok.filegallery.filepicker.model.FileListItem;
import dev.ragnarok.filegallery.filepicker.model.MarkedItemList;
import dev.ragnarok.filegallery.filepicker.utils.ExtensionFilter;
import dev.ragnarok.filegallery.filepicker.utils.Utility;
import dev.ragnarok.filegallery.filepicker.widget.MaterialCheckbox;
...
public class FilePickerDialog extends DialogFragment implements AdapterView.OnItemClickListener {
    ...
    public static FilePickerDialog newInstance(@NonNull DialogProperties properties) {
        ...
        args.putParcelable(Extra.PROPS, properties);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (size == 0) {
            ...
            int color = CurrentTheme.INSTANCE.getColorOnPrimary(requireActivity());
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        properties = requireArguments().getParcelable(Extra.PROPS);
